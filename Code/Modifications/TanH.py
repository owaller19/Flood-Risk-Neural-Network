...
class NeuralNetwork:
    def __init__(self, input_nodes, hidden_nodes, output_nodes, seed=10):
        ...
        np.random.seed(seed)
        # Initialize weights and biases with Xavier/Glorot initialization suited for tanh
    ...
    def forward_pass(self, inputs):
        ...
        self.hidden_layer_output = tanh(self.hidden_layer_activation)
        self.output_layer_activation = np.dot(self.hidden_layer_output, self.weights_hidden_output) + self.bias_output
        self.predicted_output = tanh(self.output_layer_activation)
    ...
    def backward_pass(self, actual_output):
        ...
        d_predicted_output = d_loss_predicted_output * tanh_derivative(self.predicted_output)
        
        error_hidden_layer = d_predicted_output.dot(self.weights_hidden_output.T)
        d_hidden_layer = error_hidden_layer * tanh_derivative(self.hidden_layer_output)
